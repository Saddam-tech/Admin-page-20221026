...
export default function MintingPopup({ off }) {
  ...
  return (
    <MintingPopupBox className="defaultPopup">
      <strong className="title">eCER Minting</strong>
      ...
      <ul className="inputList">
        ...
        <li>
          <p className="key">Minting quantity</p>
          <div className="value">
            <input
              type={"number"}
              value={quantity}
      ...
      <div className="btnBox">
        ...
        <button
          ...
          disabled={!(name && contract && symbol && quantity && phoneNum)}
...
const MintingPopupBox = styled.section`
  width: 520px;
